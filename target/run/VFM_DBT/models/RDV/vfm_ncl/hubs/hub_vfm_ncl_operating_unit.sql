-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into VESSOPS_D.L00_STG.hub_vfm_ncl_operating_unit as DBT_INTERNAL_DEST
        using VESSOPS_D.L00_STG.hub_vfm_ncl_operating_unit__dbt_tmp as DBT_INTERNAL_SOURCE
