-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into VESSOPS_D.L00_STG.lnk_vfm_ncl_ou_voyage_account as DBT_INTERNAL_DEST
        using VESSOPS_D.L00_STG.lnk_vfm_ncl_ou_voyage_account__dbt_tmp as DBT_INTERNAL_SOURCE
