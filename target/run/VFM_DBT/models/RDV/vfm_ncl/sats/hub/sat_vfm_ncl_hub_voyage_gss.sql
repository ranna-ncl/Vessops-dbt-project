-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into VESSOPS_D.L00_STG.sat_vfm_ncl_hub_voyage_gss as DBT_INTERNAL_DEST
        using VESSOPS_D.L00_STG.sat_vfm_ncl_hub_voyage_gss__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
